              ...
              <form onSubmit={handleSubmit} className="space-y-4 md:space-y-6">
                <div>
                  ...
                  value={email}
                    ...
                    className="bg-purple border border-purple_dark sm:text-sm rounded-lg outline-none block w-full p-2.5 text-white"
                ...
                <div>
                  ...
                  <input
                    ...
                    id="password"
                    placeholder="••••••••"
                    className="bg-purple border border-purple_dark sm:text-sm rounded-lg outline-none block w-full p-2.5"
                  />
                </div>
