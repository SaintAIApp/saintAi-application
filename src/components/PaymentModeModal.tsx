...
const PaymentModeModal = ({ triggerButton, createStripeCheckout, createCoinbaseCheckout }: { triggerButton: React.ReactNode, createStripeCheckout: any, createCoinbaseCheckout: any }) => {
