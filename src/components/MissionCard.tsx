...
const MissionCard: React.FC<Props> = ({ number, heading, description,className="" }) => {
  return (
    <div className={`border-[0.8px] border-purple_dark bg-opacity-40 bg-purple  px-4 py-3 rounded-3xl md:w-56 lg:w-72  hover:shadow-inner hover:shadow-purple_dark duration-500 ${className}`}>
