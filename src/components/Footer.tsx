...
const Footer = () => {
  return (
    <div className="relative overflow-hidden border-[1.8px] p-10 rounded-3xl  border-purple_dark bg-purple bg-opacity-70 grid grid-cols-3 place-content-between ">
